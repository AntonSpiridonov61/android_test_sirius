...
class DataModel(
    val image: String = "https://ibb.co/37KzF03/img-background.png",
    val logo: String = "https://ibb.co/GpbZg5t/img-logo.png",
    ...
    val reviews: List<ReviewModel> = listOf(
        ReviewModel(
            userImage = "https://ibb.co/WcJMjSw/img-user-1.png",
        ...
        ReviewModel(
            userImage = "https://ibb.co/p1q4QZr/img-user-2.png",
